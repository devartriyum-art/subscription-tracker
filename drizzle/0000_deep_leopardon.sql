...
--> statement-breakpoint
CREATE INDEX `reminder_unique_idx` ON `reminder_log` (`subscription_id`,`due_date`,`days_before`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `usage_subscription_idx` ON `usage_snapshots` (`subscription_id`);--> statement-breakpoint
CREATE TABLE `users` (
	`id` text PRIMARY KEY NOT NULL,
	`email` text NOT NULL,
	`name` text NOT NULL,
